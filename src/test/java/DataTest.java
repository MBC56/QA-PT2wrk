...
class DataTest {
    ...
    void testConvertToMegabytes() {
        ...
        assertEquals(0.0009765625, Data.convertToMegabytes(), 0.01);
        ...
        assertEquals(2048.0, Data.convertToMegabytes(), 0.01);

        new Data(1, "invalidunit", 100);
        assertThrows(IllegalArgumentException.class, Data::convertToMegabytes);
    }
    ...
    void testGetFormattedDownloadTime() {
        Data data1 = new Data(1024, "kilobytes", 100);
        assertEquals("0 minutes 0 seconds", Data.getFormattedDownloadTime());

        Data data2 = new Data(512, "megabytes", 200);
        assertEquals("0 minutes 20 seconds", Data.getFormattedDownloadTime());

        Data data3 = new Data(1536, "megabytes", 512);
        assertEquals("0 minutes 24 seconds", Data.getFormattedDownloadTime());
